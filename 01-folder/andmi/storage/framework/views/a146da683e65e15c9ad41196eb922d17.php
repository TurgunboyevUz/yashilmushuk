<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="<?php echo e(route('employee.inspeksiya.edit-profile')); ?>" class="dropdown-item">
...
<?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/layouts/employee/inspeksiya/navbar.blade.php ENDPATH**/ ?>