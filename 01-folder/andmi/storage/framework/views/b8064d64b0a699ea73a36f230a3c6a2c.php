...
<div class="content-wrapper">
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            <form id="startupForm" action="<?php echo e(route('student.startup')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <!-- Yutuq turi -->
            ...
            <table class="table table-bordered table-hover table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('student.startup.destroy')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts::student.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/student/startup.blade.php ENDPATH**/ ?>