                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="ml-auto d-flex">
                                <button id="excelDownload" class="btn btn-success" onclick="window.location = '<?php echo e(route('excel.general-institute')); ?>';">
                                ...
                                <table id="studentsInstituteRatingTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($student['teacher']); ?></td>
...
<?php echo $__env->make('layouts::employee.inspeksiya.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/inspeksiya/rating/general-institute.blade.php ENDPATH**/ ?>