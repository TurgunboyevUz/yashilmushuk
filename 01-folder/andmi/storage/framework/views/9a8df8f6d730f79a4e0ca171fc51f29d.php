                ...
                <div class="card card-outline card-primary">
                    <div class="card-header login-header">
                        <div class="logo-container">
                            <a href="/" aria-label="Bosh sahifa">
                                <img src="<?php echo e(asset('img/logo.png')); ?>" alt="BMI Platform logotipi" class="img-fluid">
                            </a>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-3">
                            <a href="<?php echo e(route('student.login')); ?>" class="login-button btn-student">
                                <i class="fas fa-user-graduate mr-2"></i>Talaba HEMIS orqali kirish
                            </a>
                            <a href="<?php echo e(route('employee.login')); ?>" class="login-button btn-teacher">
...
<?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/auth/login.blade.php ENDPATH**/ ?>