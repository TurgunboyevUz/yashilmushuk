...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="<?php echo e(route('main')); ?>" class="navbar-brand p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary py-2 px-4 ms-3">TIZIMGA KIRISH</a>
            </div>
        </nav>
...
<?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/welcome.blade.php ENDPATH**/ ?>