                ...
                <div class="col-md-4">
                    <div class="card card-widget widget-user">
                        <div class="widget-user-header bg-info">
                            ...
                            <h5 class="widget-user-desc"><?php echo e($department->pivot->staff_position ?? ''); ?></h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="card border-info">
                                ...
                                <div class="card-body scrollable-card-body">
                                    <div class="list-group">
                                        <?php if(count($data['top3_att']) == 0): ?>
                                            <h5 class="text-center">O'qituvchiga biriktirilgan talabalar mavjud emas.</h5>
                                        <?php endif; ?>
                                        <?php $__currentLoopData = $data['top3_att']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="card border-info">
                                ...
                                <div class="card-body scrollable-card-body">
                                    <ul class="list-group">
                                        <?php $__currentLoopData = $data['top3_dep']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <br>
                                                <small class="text-muted">Mutaxasislik: <?php echo e($item['specialty']); ?></small>
                                                <br>
                                                <small class="text-muted">Toifa: <?php echo e($item['staff_position']); ?></small>
                                            </div>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="card border-danger">
                                ...
                                <div class="card-body scrollable-card-body">
                                    <ul class="list-group">
                                        <?php $__currentLoopData = $data['top3_fac']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <span class="mr-2">
                                                <img src="<?php echo e($item['picture_path']); ?>" alt="User Avatar" class="img-circle elevation-2" style="width: 50px; height: 50px;">
                                            </span>
...
<?php echo $__env->make('layouts::employee.teacher.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/teacher/dashboard.blade.php ENDPATH**/ ?>