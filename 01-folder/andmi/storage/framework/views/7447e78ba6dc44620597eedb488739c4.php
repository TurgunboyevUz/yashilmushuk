                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="ml-auto d-flex">
                                <button id="zipDownload" class="btn btn-success" data-url="<?php echo e(route('storage.zip')); ?>"  data-name="lang_certificates">
                                ...
                                <table id="languageCertificatesTable" class="table table-bordered table-responsive table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($item->lang_certificate->lang()); ?></td>
                                            <td><?php echo e($item->lang_certificate->type()); ?></td>
                                            <td><?php echo e($item->lang_certificate->criteria->name); ?></td>
                                            <td><?php echo e($item->lang_certificate->given_date); ?></td>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success confirmAction" data-id="<?php echo e($item->lang_certificate->id); ?>" data-url="<?php echo e(route('employee.inspeksiya.lang-certificate.approve')); ?>" ><i class="fas fa-check"></i></button>
                                                <button class="btn btn-sm btn-danger cancelAction" data-id="<?php echo e($item->lang_certificate->id); ?>" data-url="<?php echo e(route('employee.inspeksiya.lang-certificate.reject')); ?>" ><i class="fas fa-ban"></i></button>
                                            </td>
...
<?php echo $__env->make('layouts::employee.inspeksiya.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/inspeksiya/lang-certificate.blade.php ENDPATH**/ ?>