...
<div class="content-wrapper">
    ...
    <div class="card mt-3">
        <div class="card-body">
            <form id="profileForm" action="<?php echo e(route('employee.talent.edit-profile')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
...
<?php echo $__env->make('layouts::employee.talent.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/talent/edit-profile.blade.php ENDPATH**/ ?>