    ...
    <section class="content">
        <div class="container-fluid my-4">
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <form id="bmiScoreForm" action="<?php echo e(route('employee.inspeksiya.evaluation-criteria')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="score[<?php echo e($criteria->id); ?>]" type="number" class="form-control form-control-sm" value="<?php echo e($criteria->score); ?>" min="0" maxlength="2">
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts::employee.inspeksiya.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/inspeksiya/evaluation-criteria.blade.php ENDPATH**/ ?>