...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="<?php echo e(asset('img/bmi_logo.jpg')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 0.8" />
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                <li class="nav-item">
                    <a href="<?php echo e(route('employee.inspeksiya.dashboard')); ?>" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.article')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.scholarship')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.invention')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.startup')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.grand-economy')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.olympics')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.lang-certificate')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.achievement')); ?>" class="nav-link active">
                                <i class="nav-icon fas fa-award"></i>
                                <p>O’quv yili davomida <br>erishgan boshqa yutuqlari
                                    <br><span class="right badge badge-info"><?php echo e($counts['achievements']); ?></span>
                                </p>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('employee.inspeksiya.student-list')); ?>" class="nav-link">
                        <i class="nav-icon fas fa-chalkboard-teacher"></i>
                        <p>Talabalar ro'yxati</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('employee.inspeksiya.evaluation-criteria')); ?>" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.rating.institute')); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Institut reytingi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.inspeksiya.rating.general-institute')); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/layouts/employee/inspeksiya/sidebar.blade.php ENDPATH**/ ?>