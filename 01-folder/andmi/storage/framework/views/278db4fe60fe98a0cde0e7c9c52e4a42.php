                                ...
                                <table id="inventionsTable" class="table table-bordered table-responsive table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success confirmAction" data-id="<?php echo e($item->invention->id); ?>" data-url="<?php echo e(route('employee.inspeksiya.invention.approve')); ?>" ><i class="fas fa-check"></i></button>
                                                <button class="btn btn-sm btn-danger cancelAction" data-id="<?php echo e($item->invention->id); ?>" data-url="<?php echo e(route('employee.inspeksiya.invention.reject')); ?>" ><i class="fas fa-ban"></i></button>
                                            </td>
...
<?php echo $__env->make('layouts::employee.inspeksiya.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codearch/Backup/01-folder/andmi/resources/views/inspeksiya/invention.blade.php ENDPATH**/ ?>