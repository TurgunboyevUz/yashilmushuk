                                ...
                                <table id="contractsTable" class="table table-bordered table-responsive table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success confirmAction" data-id="{{ $item->grand_economy->id }}" data-url="{{ route('employee.teacher.grand-economy.review') }}" ><i class="fas fa-check"></i></button>
                                                <button class="btn btn-sm btn-danger cancelAction" data-id="{{ $item->grand_economy->id }}" data-url="{{ route('employee.teacher.grand-economy.reject') }}" ><i class="fas fa-ban"></i></button>
                                            </td>
