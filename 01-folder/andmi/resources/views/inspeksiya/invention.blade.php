                                ...
                                <table id="inventionsTable" class="table table-bordered table-responsive table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success confirmAction" data-id="{{ $item->invention->id }}" data-url="{{ route('employee.inspeksiya.invention.approve') }}" ><i class="fas fa-check"></i></button>
                                                <button class="btn btn-sm btn-danger cancelAction" data-id="{{ $item->invention->id }}" data-url="{{ route('employee.inspeksiya.invention.reject') }}" ><i class="fas fa-ban"></i></button>
                                            </td>
