                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="ml-auto d-flex">
                                <button id="zipDownload" class="btn btn-success" data-url="{{ route('storage.zip') }}"  data-name="lang_certificates">
                                ...
                                <table id="languageCertificatesTable" class="table table-bordered table-responsive table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success confirmAction" data-id="{{ $item->lang_certificate->id }}" data-url="{{ route('employee.inspeksiya.lang-certificate.approve') }}" ><i class="fas fa-check"></i></button>
                                                <button class="btn btn-sm btn-danger cancelAction" data-id="{{ $item->lang_certificate->id }}" data-url="{{ route('employee.inspeksiya.lang-certificate.reject') }}" ><i class="fas fa-ban"></i></button>
                                            </td>
